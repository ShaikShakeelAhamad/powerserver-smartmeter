...
class ECDHCustomerServer : AppCompatActivity() {
    ...
    private fun getServerECPublicKey() {
        ...
        if (checkNetworkConnection()) {
            ...
            lifecycleScope.launch {
                val result = httpPost("https://webmah.com/powerservercustomerpaymentapp/ServerAuthAtClient.php", jsonObject)
    ...
    private fun verifyClintAtServer() {
        ...
        if (checkNetworkConnection()) {
            ...
            lifecycleScope.launch {
                val result = httpPost("https://webmah.com/powerservercustomerpaymentapp/ClientAuthAtServer.php", jsonObject)
